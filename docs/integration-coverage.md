...
The detailed semantic matrix is maintained in:
...
- what OrbitFabric semantics are meaningful for F Prime;
- what the first adapter release deliberately claims;
- what FPP represents only partially;
- what F Prime cannot generically represent;
